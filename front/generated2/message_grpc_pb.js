...
function serialize_Posts_AddPostRequest(arg) {
  if (!(arg instanceof message_pb.AddPostRequest)) {
...
function deserialize_Posts_AddPostRequest(buffer_arg) {
  return message_pb.AddPostRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_Posts_AddPostResponse(arg) {
  if (!(arg instanceof message_pb.AddPostResponse)) {
...
function deserialize_Posts_AddPostResponse(buffer_arg) {
  return message_pb.AddPostResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_Posts_GetPostsResponse(arg) {
  if (!(arg instanceof message_pb.GetPostsResponse)) {
...
function deserialize_Posts_GetPostsResponse(buffer_arg) {
  return message_pb.GetPostsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var PostsService = exports.PostsService = {
  getPosts: {
    ...
    responseType: message_pb.GetPostsResponse,
  ...
  addPost: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: message_pb.AddPostRequest,
    responseType: message_pb.AddPostResponse,
